...
<div class="header">
    ...
    <div>
        <i style="margin-right: 18px;" @click="$emit('new-chat')" class="pi pi-comment"></i>
    ...
    <Drawer v-model:visible="isSidebarOpen" class="sidebar" header="Ripplecurve">
        <div class="sidebar-container">
            <div class="chat-history-container">
                <div style="font-size: large; font-weight: bold;">Conversation History</div>
                <div v-for="history in chatHistory" class="history-item">
                    {{ history.title }}
                </div>
            </div>
            <div>
                <i class="pi pi-user" style="margin-right: 8px;"></i>Keshav
            </div>
        </div>
    </Drawer>
</div>
